...
public class GuiNoOptions extends GuiBase {
    ...
    protected void postButtonRender(GuiGraphics guiGraphics, int x, int y, int mouseX, int mouseY, float partialTicks) {
        this.drawSplitString(guiGraphics, GuiLangKeys.translateString(GuiLangKeys.NO_OPTIONS_PART_1), x + 8, y + 15, 260);
        this.drawSplitString(guiGraphics, GuiLangKeys.translateString(GuiLangKeys.NO_OPTIONS_PART_2), x + 8, y + 50, 260);
    }
